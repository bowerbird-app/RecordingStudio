...
* bump `flat_pack` to `v0.1.117` to address dependency audit vulnerabilities
* update the dummy app sidebar header version badge to show `RecordingStudio::VERSION` instead of `FlatPack::VERSION`

### Documentation

* update README and upgrade guidance to reflect the `3.0.2` release and sidebar version badge behavior in the dummy sandbox
