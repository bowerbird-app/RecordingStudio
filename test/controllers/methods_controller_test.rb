...
class MethodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "recordables renders recordable declaration catalog" do
    ...
    assert_includes @response.body, "class MessagesRoot &lt; ApplicationRecord"
    assert_includes @response.body, "plural_label: &quot;Workspaces&quot;"
    assert_includes @response.body, "root: true"
    assert_includes @response.body, "shared: true"
  ...
  test "identity renders identity method catalog" do
    ...
    assert_includes @response.body, "RecordingStudio::Labels.name_for"
    assert_includes @response.body, "RecordingStudio::Labels.summary_for"
    assert_includes @response.body, "recording.name"
    assert_includes @response.body, "recording.label"
  ...
  test "crud renders CRUD method catalog" do
    ...
    assert_includes @response.body, "RecordingStudio::Duplication.reset_counter_caches"
    assert_includes @response.body, "RecordingStudio.update_polymorphic_counter"
    refute_includes @response.body, "root_recording.record"
  ...
  test "events renders event method catalog" do
    ...
    assert_includes @response.body, "recording.recordables"
  ...
  test "queries renders query method catalog" do
    ...
    assert_includes @response.body, "RecordingStudio::Recording.lock_ids!"
    assert_includes @response.body, "root_recording.recordings_query"
    assert_includes @response.body, "root_recording.recordings_with_children"
    assert_includes @response.body, "root_recording.recordings_with_descendants"
    assert_includes @response.body, "root_recording.recordings_without_children"
    ...
    assert_includes @response.body, "href=\"#root-recording-recordings-with-children\""
    assert_includes @response.body, "href=\"#root-recording-recordings-with-descendants\""
    assert_includes @response.body, "href=\"#root-recording-recordings-without-children\""
  ...
  test "tree renders traversal method catalog" do
    ...
    assert_includes @response.body, "recording.shared_root?"
    assert_includes @response.body, "recording.shared_root_tree?"
  ...
  def assert_root_catalog_content
    assert_includes @response.body, "Root"
    assert_includes @response.body, "RecordingStudio.root_recording_for"
    assert_includes @response.body, "RecordingStudio.root_recording_or_self"
    assert_includes @response.body, "RecordingStudio.root_recording_id_for"
    assert_includes @response.body, "RecordingStudio.root_recording?"
    assert_includes @response.body, "RecordingStudio.shared_root_type?"
    assert_includes @response.body, "RecordingStudio.shared_root_types"
    assert_includes @response.body, "RecordingStudio.shared_root_declarations"
    assert_includes @response.body, "RecordingStudio.shared_root?"
    assert_includes @response.body, "RecordingStudio.shared_root_tree?"
    assert_includes @response.body, "RecordingStudio.assert_root_recording!"
    assert_includes @response.body, "RecordingStudio.assert_recording_belongs_to_root!"
    assert_includes @response.body, "RecordingStudio.assert_parent_recording_belongs_to_root!"
    ...
    assert_includes @response.body, "Use shared: true for a domain forest such as messages"
