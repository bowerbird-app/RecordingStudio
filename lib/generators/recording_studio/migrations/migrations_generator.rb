...
module RecordingStudio
  module Generators
    # Generator to install RecordingStudio migrations into the host application.
    #
    # Usage:
    #   rails generate recording_studio:migrations
    #
    # Options:
    ...
    class MigrationsGenerator < Rails::Generators::Base
      ...
      def copy_migrations
        ...
        migration_files.each do |source_path|
          ...
          # Extract migration name without timestamp (e.g., "create_recording_studio_recordings.rb")
