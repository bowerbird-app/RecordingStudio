...
module ControlRoom
  module Generators
    # Generator to install ControlRoom migrations into the host application.
    #
    # Usage:
    #   rails generate control_room:migrations
    #
    # Options:
    ...
    class MigrationsGenerator < Rails::Generators::Base
      ...
      desc "Copy ControlRoom migrations to your application"
      ...
      def copy_migrations
        ...
        unless File.directory?(migrations_dir)
          say "No migrations found in ControlRoom engine.", :yellow
          return
        end
        ...
        migration_files.each do |source_path|
          ...
          # Extract migration name without timestamp (e.g., "create_control_room_recordings.rb")
